...
document.getElementById("fname").innerHTML=students.student[1].Firstname;
document.getElementById("lname").innerHTML=students.student[1].Lastname;
document.getElementById("age").innerHTML=students.student[1].age;